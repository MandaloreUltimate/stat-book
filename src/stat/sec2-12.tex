...
\begin{defn}
    ...
    \begin{equation*}
        1 = 
        \int\limits_{-\infty}^{\infty} p_{\xi}(x) dx =
        c \int\limits_{0}^{\infty} x^{\alpha-1} e^{-\lambda x} dx =
...
\begin{lem}
    ...
    Тогда их сумма $S_{n}=\xi_{1}+\cdots+\xi_{n} \sim \GammaDist_{\lambda, \alpha_1 + \cdots + \alpha_n}$.
\end{lem}
\begin{proof}
    ...
    Тогда, если у нас есть независимые случайные величины $\xi_1, \ldots, \xi_n, \: \xi_i \sim \GammaDist_{\lambda, \alpha_i}$,
    ...
    По теореме Леви о непрерывности заключаем, что сумма имеет распределение $\GammaDist_{\lambda, \alpha_1 + \ldots + \alpha_n}$.
\end{proof}
...
\begin{proof}
    ...
    \begin{gather*}
        \MyPr(\xi^2 < x) = \MyPr(|\xi| < \sqrt{x}) = 2 \, \MyPr(0 < \xi < \sqrt{x}) = \\
...
\begin{crlr}
    Если $\xi_{1}, \ldots, \xi_{k}$ независимы и $\xi_i \sim \Normal_{0,1}$, то случайная величина $\chi^{2}=\xi_{1}^{2}+\cdots+\xi_{k}^{2} \sim \GammaDist_{1/2, k/2}$
\end{crlr}
...
\begin{enumerate}
    ...
    \end{equation*}
    \item Пусть случайные величины $\xi_1, \ldots, \xi_k$ независимы и $\xi_i \sim \Normal_{a,\sigma^{2}}$. Тогда
    \begin{equation*}
...
\begin{enumerate}
    ...
    \item $\Student_{k} \xrightarrow[k \to \infty]{\text{d}} \Normal_{0,1}$.
...
\begin{enumerate}
    ...
    \begin{equation*}
        \MyPr\left(\SampleMean-\frac{\tau \sigma}{\sqrt{n}}<a<\SampleMean+\frac{\tau \sigma}{\sqrt{n}}\right)=\alpha, ~ \text {где} ~ \Phi_{0,1}(\tau)=\frac{1 + \alpha}{2}
    \end{equation*}
    ...
    \begin{equation*}
        \alpha=\MyPr\left(g_{1}<\frac{n S_{1}^{2}}{\sigma^{2}}<g_{2}\right)=\MyPr\left(\frac{n S_{1}^{2}}{g_{2}}<\sigma^{2}<\frac{n S_{1}^{2}}{g_{1}}\right)
    \end{equation*}
