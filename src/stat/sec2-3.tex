...
\begin{enumerate}[label={\arabic*.}]
    ...
    \begin{equation*}
        \ExpTh \SampleMean=\frac{1}{n}\bigl(\ExpTh  X_{1}+\cdots+\ExpTh X_{n}\bigr)=\frac{1}{n} \cdot n \, \ExpTh X_{1}= \ExpTh  X_{1} = a.
    \end{equation*}
    \item Из ЗБЧ в форме Хинчина:
    \begin{equation*}
        \SampleMean = 
        \cfrac{X_{1}+\cdots+X_{n}}{n} \xrightarrow[n \to \infty]{\text{p}} \ExpTh X_{1} = a.
    \end{equation*}
    ...
    \begin{gather*}
        ...
        \xrightarrow[n \to \infty]{\text{d}} \Normal_{0, 1} \qedhere
    \end{gather*}
\end{enumerate}
\end{proof}
...
\begin{enumerate}
    ...
    а ${\overline{Y} \cdot \sqrt{n} \, \overline{Y} \xrightarrow[n \to \infty]{\text{d}} 0}$ как произведение последовательностей ${\overline{Y} \xrightarrow[n \to \infty]{\text{p}} 0}$ и ${\sqrt{n} \, \overline{Y} \xrightarrow[n \to \infty]{\text{d}} \Normal_{0, \VarTh  X_{1}}}$. \qedhere
\end{enumerate}
\end{proof}
