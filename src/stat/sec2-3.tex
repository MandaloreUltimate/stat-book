...
\begin{enumerate}
    ...
    а ${\overline{Y} \cdot \sqrt{n} \, \overline{Y} \xrightarrow[n \to \infty]{\text{d}} 0}$ как произведение последовательностей ${\overline{Y} \xrightarrow[n \to \infty]{\text{p}} 0}$ и ${\sqrt{n} \, \overline{Y} \xrightarrow[n \to \infty]{\text{d}} \Normal_{0, \VarTh  X_{1}}}$.
\end{enumerate}
\end{proof}
