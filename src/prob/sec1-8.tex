...
\begin{multline*}
    ...
    \MyPr(\xi_1 = 0) \cdot \MyPr(\xi_2 = 0) \cdot \cdots \cdot \MyPr(\xi_{k-1} = 0) \cdot \MyPr(\xi_k = 1) =
    q^{k-1}p.
\end{multline*}
...
Аналогично можно ввести геометрическое распределение как <<число неудач до первого успеха>> ($\GeomZero_{p}$).
...
\begin{thm*}
    Рассмотрим серию схем Бернулли~--- последовательность схем Бернулли с количеством испытаний $n$ и вероятностями успеха $p_n$ (т.е. в первой схеме~--- одно испытание с вероятностью успеха $p_1$, во второй~--- два испытания с вероятностью успеха $p_2$ и т.д.). В каждой схеме рассмотрим случайную величину $\tau_n \sim \Geom_{p_n}$.
...
\begin{proof}
    ...
    \begin{multline*}        
        ...
        p_n \, \frac{1 - q_n^{\lfloor nx \rfloor}} {1-q_n} =
        1-\left(1-p_{n}\right)^{\lfloor nx \rfloor}
    \end{multline*}
    ...
    или, что эквивалентно, $nx - 1 < \lfloor nx \rfloor \leqslant nx$.
    Таким образом, верно $(1 - p_n)^{\lfloor nx \rfloor} \xrightarrow[n \to +\infty]{} e^{-\lambda x}$.
