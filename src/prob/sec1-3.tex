\section{Случайная величина. Порождённое и индуцированное вероятностные пространства. Функция распределения, её свойства}
...
прообразом борелевского множества ${C \colon 0 \in C, \, 1 \in C}$~--- вся вещественная прямая, 
...
\begin{proof}
    ...
    \end{equation*}
    Мы получили, что прообраз произвольного борелевского множества принадлежит $\sigma$-алгебре. 
...
\begin{enumerate}
    ...
    \item 
        ...
        $F_\xi(-n) = \MyPr(B_n) \xrightarrow[n \to +\infty]{} \MyPr(\varnothing) = 0$ (в силу непрерывности вероятностной меры). Отсюда следует:
