...
\begin{defn}
    Случайная величина $\xi$ имеет \textit{нормальное (гауссовское) распределение} с параметрами $\alpha$ и $\sigma^2$ ($\Normal_{\alpha, \sigma^2}$), где $\alpha \in \Real, \sigma > 0$, если $\xi$ имеет следующую плотность распределения:
\begin{equation*}
    f(x)=\frac{1}{\sigma \sqrt{2 \pi}} e^{-\frac{(x-\alpha)^{2}}{2 \sigma^{2}}}, \quad x \in \Real.
\end{equation*}
\end{defn}

\subsubsection{Числовые характеристики $\Normal_{\alpha, \sigma^2}$}
...
\begin{multline*}
    ...
    \left. -\frac{1}{\sqrt{2\pi}} e^{\frac{-x^2}{2}}\right|_{-\infty}^{\infty} = 0 \\
