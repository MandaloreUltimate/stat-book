\section{Неравенства Маркова, Чебышёва и Гаусса. Правило «трёх сигм». Закон больших чисел в форме Чебышёва}
...
\begin{proof}
    Для $\varepsilon > 0$ неравенство $|\xi - \Exp \xi| \geqslant \varepsilon \iff (\xi - \Exp \xi)^2 \geqslant \varepsilon^2$, поэтому $\MyPr(|\xi-\Exp \xi| \geqslant \varepsilon) = 
        ...
        \frac{\Exp (\xi-\Exp \xi)^{2}}{\varepsilon^{2}} =
...
\begin{namedthm}[Неравенство Гаусса]
    ...
    \begin{equation*}
        \MyPr(|X-m|>k) \leqslant
        \begin{cases}
            \left(\frac{2 a}{3 k}\right)^{2}, & \text{если $k \geqslant \frac{2 a}{\sqrt{3}}$;} \\
            1 - \frac{k}{a \sqrt{3}}, & \text{если $0 \leqslant k \leqslant \frac{2 a}{\sqrt{3}}$.}
        \end{cases}
    \end{equation*}
\end{namedthm}
...
\begin{defn}
    ...
    \begin{equation*}
        \frac{\biggl( \xi_{1}+\cdots+\xi_{n} \biggr) - \biggl(\Exp \xi_{1}+\cdots+\Exp \xi_{n} \biggr)}{n} \xrightarrow[n \to +\infty]{\text{P}} 0 %\: \text {при} \: n \to +\infty.
    \end{equation*}
\end{defn}
\begin{namedthm}[Закон больших чисел в форме Чебышёва]
    ...
    \begin{equation*}
        \frac{\xi_{1}+\cdots+\xi_{n}}{n} \xrightarrow[]{\text{P}} \Exp \xi_{1}.
    \end{equation*}
\end{namedthm}

\begin{proof}
    Обозначим через $S_n = \xi_1 + \cdots + \xi_n$ сумму первых $n$ случайных величин. Из линейности матожидания получим
    \begin{equation*}
        \Exp \left(\frac{S_{n}}{n}\right)=\frac{\Exp \xi_{1}+\cdots+\Exp \xi_{n}}{n}=\frac{n \Exp \xi_{1}}{n}=\Exp \xi_{1}.
    \end{equation*}
    ...
    \begin{multline*}
        ...
        = \frac{\Var \xi_{1}+\cdots+\Var \xi_{n}}{n^{2} \varepsilon^{2}}= \\
        = \frac{n \Var \xi_{1}}{n^{2} \varepsilon^{2}}
        = \frac{\Var \xi_{1}}{n \varepsilon^{2}} \xrightarrow[n \to +\infty]{} 0,
    \end{multline*}
    так как $\Var\xi_1 < \infty$. Дисперсия суммы превратилась в сумму дисперсий в силу попарной независимости слагаемых, из-за которой все ковариации $\Cov(\xi_i, \xi_j)$ по свойству ковариации обратились в нуль при $i \neq j$.
\end{proof}

\begin{rmrk}
    Условие попарной независимости является избыточным~--- достаточно равенства нулю ковариаций, т.е. некоррелированности случайных величин.
\end{rmrk}
