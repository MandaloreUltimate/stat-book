...
\begin{proof}\leavevmode
	\begin{enumerate}
		...
		\item 
			  ...
			  \begin{equation*}
				\lim\limits_{k \to \infty} \MyPr(A_k) = \MyPr(A). \qedhere
			  \end{equation*}
	\end{enumerate}
\end{proof}
...
\begin{exmp}
	...
	\end{compactlist}
    В то же время тройка $([-1, 1], \Borel_{[-1, 1]}, \lambda_{[-1, 1]})$ не будет вероятностным пространством, т.к. нарушается свойство нормировки вероятностной меры: $\lambda(\Omega) = 2$, следовательно, вероятность не задана.
\end{exmp}
