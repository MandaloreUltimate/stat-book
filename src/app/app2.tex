...
\begin{mytable}
	\begin{center}
		...
		\begin{tabular}{|c|c|c|c|c|}
			...
			\hline \mylinespace[7.5pt] \doublerow{Равномерное $\Uniform_{[a, b]}$}{$a<b$} & $\cfrac{1}{b-a} \cdot \Ind(x \in [a;b])$ & $\cfrac{a+b}{2}$ & $\cfrac{b-a}{12}$ & $\cfrac{e^{i t b}-e^{i t a}}{i t(b-a)}$\\[14pt]
...
\begin{mytable}
	\begin{center}
		...
		\begin{tabular}{|c|c|c|c|}
			...
			\hline \mylinespace[7.5pt] $\GammaDist_{\theta, \alpha}$ & $\theta$ & $\cfrac{\SampleMean}{\alpha}$ & $\cfrac{\theta^2}{\alpha n}$\\[12pt]
